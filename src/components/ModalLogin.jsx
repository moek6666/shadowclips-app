...
function ModalLogin({ isOpen, onClose, supabase }) {
    ...
    const handleDiscordLogin = () => {
        // Ganti URL ini dengan link invite Discord atau integrasi OAuth Discord Bos nantinya
                        ...
                        {!isForgotPass && (
                            <>
                                ...
                                <div className="grid grid-cols-2 gap-3 w-full mb-4">
                                    ...
                                    {/* Tombol Discord Pengganti Telegram */}
                                    <button
                                        type="button"
                                        onClick={handleDiscordLogin}
                                        className="w-full h-[40px] flex items-center justify-center gap-2 bg-slate-100 dark:bg-[#161921] hover:bg-slate-200 dark:hover:bg-[#1E222D] text-slate-700 dark:text-zinc-200 rounded-[8px] font-medium transition-colors cursor-pointer border-none outline-none"
                                    >
