    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col items-center justify-center p-4 font-sans relative overflow-hidden transition-colors duration-300">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none flex items-center justify-center">
                ...
                {/* Pola Lingkaran */}
                <div className="absolute top-[40%] right-[10%] w-4 h-4 rounded-full border-4 border-zinc-200 dark:border-zinc-800"></div>
            ...
            <div className="relative z-10 flex flex-col items-center max-w-3xl w-full text-center">
                ...
                {/* Ilustrasi Amplop Flat Design (SVG Custom) */}
                <div className="relative transform hover:-translate-y-2 transition-transform duration-500 mb-8 sm:mb-10">
                    {/* Efek Cahaya Halus di Belakang Amplop */}
                    <div className="absolute inset-0 bg-[#106EBE]/10 dark:bg-[#106EBE]/20 rounded-full scale-[1.5] blur-3xl pointer-events-none"></div>
                    
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className="w-56 h-56 sm:w-72 sm:h-72 drop-shadow-2xl">
                        {/* Amplop Belakang (Flap Atas yang terbuka) */}
                        ...
                        <path d="M55,115 h50 M55,130 h80" stroke="#94a3b8" strokeWidth="4" strokeLinecap="round"/>
