...
export default function DownloadApk({ supabase }) {
    ...
    const apkDownloadLink = "https://www.mediafire.com/file/qrrl93nzsh3joed/ShadowCLips_Final.apk/file";
    ...
    const dict = {
        id: {
            ...
            step2Title: 'Izinkan Instalasi Dan Notifikasi',
            step2Desc: 'Buka pengaturan perangkat Anda, lalu aktifkan opsi pemasangan aplikasi dari sumber tidak dikenal jika diminta, Kemudian Izinkan Notifikasi Untuk Update Video Terbaru, Serta Komentar Balesan Dari User Lain.',
        ...
        en: {
            ...
            step2Title: 'Allow Installation And Notification',
            step2Desc: 'Open your device settings and enable app installation from unknown sources if prompted, You Can Recive Update New Video, And New Comment Replay From Another User.',
